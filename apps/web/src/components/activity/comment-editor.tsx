...
export default function CommentEditor({
  ...
  const editor = useEditor(
    {
      ...
      extensions: [
        StarterKit.configure({
          ...
          trailingNode: false,
          codeBlock: {
            HTMLAttributes: { class: "maki-tiptap-codeblock" },
          },
        }),
        Markdown.configure({
          markedOptions: {
      ...
      editorProps: {
        attributes: {
          class: cn(
            proseClassName || "maki-comment-editor-prose",
            readOnly && "maki-comment-editor-prose-readonly",
          ),
        },
          ...
          if (issueKey || taskIdFromUrl) {
            ...
            view.dispatch(
              view.state.tr.replaceSelectionWith(
                view.state.schema.nodes.makiIssueLink.create({
                  url,
                  issueKey: issueKey || "",
  ...
  useEffect(() => {
    ...
    const handleImagePreviewClick = (event: MouseEvent) => {
      ...
      if (!target.classList.contains("maki-editor-image")) return;
  ...
  const handleEditorMouseMove = useCallback(
    (event: ReactMouseEvent<HTMLElement>) => {
      if (disabled) return;
      const target = event.target as HTMLElement;
      if (target.closest(".maki-codeblock-language")) return;
      const hovered = target.closest(
        "pre.maki-tiptap-codeblock",
      ) as HTMLElement | null;
    ...
    (event: ReactMouseEvent<HTMLElement>) => {
      ...
      codeLanguageHideTimeoutRef.current = window.setTimeout(() => {
        ...
        const pickerIsHovered = Boolean(
          document.querySelector(".maki-codeblock-language:hover"),
        );
  ...
  return (
    <section
      ...
      className={cn(
        "maki-comment-editor-shell",
        isDragActive && "is-drag-active",
        readOnly && "maki-comment-editor-shell-readonly",
        className,
      )}
    ...
    >
      ...
      {editor && hoveredCodeBlock && !disabled && (
        <div
          className="maki-codeblock-language"
          style={{
        ...
        >
          <button
            type="button"
            className="maki-codeblock-language-trigger maki-codeblock-copy-trigger"
            aria-label={
              isCodeCopied
          ...
          {!readOnly && (
            ...
            >
              <DropdownMenuTrigger asChild>
                <button
                  type="button"
                  className="maki-codeblock-language-trigger"
                >
      ...
      {editor && !readOnly && !disabled && showBubbleMenu && (
        <BubbleMenu
          editor={editor}
          className="maki-comment-editor-bubble"
        ...
        >
          ...
          <Button
            ...
            variant="ghost"
            size="xs"
            className="maki-comment-editor-bubble-btn"
      ...
      {editor && !readOnly && !disabled && showBubbleMenu && (
        <BubbleMenu
          editor={editor}
          pluginKey="maki-comment-table-bubble"
          className="maki-comment-editor-bubble"
          shouldShow={({ editor: activeEditor, from, to }) =>
        ...
        >
          ...
          <span className="maki-tiptap-bubble-separator" />
          <Button
            type="button"
            variant="ghost"
            size="xs"
      ...
      {slashMenu && !readOnly && !disabled && (
        <div
          className="maki-tiptap-slash-menu"
          style={{
            top: slashMenu.top,
            left: slashMenu.left,
            position: slashMenuPosition,
        ...
        >
          {filteredSlashCommands.length > 0 ? (
            groupedSlashCommands.map((group) => {
              ...
              return (
                <div key={group.title} className="maki-tiptap-slash-group">
                  <div className="maki-tiptap-slash-group-title">
                    {group.title}
                  </div>
                  {group.items.map((command) => {
                    ...
                    return (
                      ...
                      >
                        <span className="maki-tiptap-slash-label">
                          {command.label}
                        </span>
                        {command.shortcut && (
                          <span className="maki-tiptap-slash-shortcut">
                            {command.shortcut}
                          </span>
                        )}
                      </button>
            ...
            <div className="maki-tiptap-slash-empty">
      ...
      {editor && embedComposer && (
        ...
        >
          {embedComposer.mode === "choice" ? (
            <div className="maki-embed-choice-menu">
              <button
                type="button"
                className="maki-embed-choice-item is-primary"
                onMouseDown={(event) => {
                  event.preventDefault();
                  submitEmbedComposer("embed");
                }}
              >
                ...
                <span className="maki-embed-choice-hint">
                  {t("activity:comment.editor.hintTab")}
                </span>
              </button>
              <button
                type="button"
                className="maki-embed-choice-item"
                onMouseDown={(event) => {
                  event.preventDefault();
                  setEmbedComposer(null);
                  setEmbedComposerError(null);
            ...
            <form
              className="maki-embed-composer-form"
              onSubmit={(event) => {
                event.preventDefault();
                submitEmbedComposer("embed");
              }}
            >
              <Input
                ...
                autoFocus
              />
              <div className="maki-embed-composer-actions">
                <Button
                  type="button"
                  size="xs"
                  variant="ghost"
              ...
              {embedComposerError && (
                <p className="maki-embed-composer-error">
      ...
      <EditorContent
        editor={editor}
        className={cn("maki-comment-editor-content", contentClassName)}
      ...
      {!readOnly && !disabled && showQuickAttachButton && (
        <button
          type="button"
          className="maki-editor-quick-attach"
          onMouseDown={(event) => {
            event.preventDefault();
          }}
          onClick={() => openImagePicker(editor)}
      ...
      {isDragActive && (
        <div className="maki-editor-drop-indicator">
