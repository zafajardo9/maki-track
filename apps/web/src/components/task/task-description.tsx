      ...
      {editor && canEdit && (
        ...
        >
          ...
          <Button
            ...
            variant="ghost"
            size="xs"
            className="maki-tiptap-bubble-btn"
            onClick={() =>
      ...
      {editor && canEdit && (
        ...
        >
          ...
          <Button
            ...
            variant="ghost"
            size="xs"
            className={cn("maki-tiptap-bubble-btn", "text-destructive")}
          ...
          {embedComposer.mode === "choice" ? (
            <div className="maki-embed-choice-menu">
              ...
              >
                ...
                <span className="maki-embed-choice-hint">Tab</span>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <span className="maki-embed-choice-hint">Esc</span>
              </button>
            </div>
          ) : (
            <form
